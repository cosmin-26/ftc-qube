...
class AutoTeren1: AutoBase() {
    ...
    private val interConeTakePose = Pose2d(35.0,0.0,Math.toRadians(-95.0)) // Mathul era -97//trb mai la stanga daca ma uit dinspre conuri    //era -93.0 grade //private val interConeTakePose = Pose2d(35.0,0.0,Math.toRadians(-92.0))
