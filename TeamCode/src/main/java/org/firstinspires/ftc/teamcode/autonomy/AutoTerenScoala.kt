...
@Autonomous
@Config
class AutoTerenScoala: AutoBase() {
    ...
    private val interConeTakePose = Pose2d(35.0,0.0,Math.toRadians(-94.0))//era -92.0 grade //private val interConeTakePose = Pose2d(35.0,0.0,Math.toRadians(-92.0))
