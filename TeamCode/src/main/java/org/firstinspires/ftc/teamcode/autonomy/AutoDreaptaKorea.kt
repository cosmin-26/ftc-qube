...
@Autonomous
@Config
class AutoDreaptaKorea: AutoBase() {
    ...
    private val interConeTakePose = Pose2d(35.0,2.0,Math.toRadians(-97.0)) // Mathul era -95//trb mai la stanga daca ma uit dinspre conuri    //era -93.0 grade //private val interConeTakePose = Pose2d(35.0,0.0,Math.toRadians(-92.0))
    ...
    override fun Hardware.run() {
        ...
        drive.followTrajectorySequence(
            drive.trajectorySequenceBuilder(Pose2d(36.23,-62.60,Math.toRadians(90.00)))
                .splineTo(Vector2d(35.68,-27.01),Math.toRadians(81.87))
                .splineTo(Vector2d(44.82,-14.08),Math.toRadians(-5.20)) //x 45.82
                .build()     //44
        )
