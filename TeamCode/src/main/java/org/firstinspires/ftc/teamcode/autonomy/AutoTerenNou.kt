...
class AutoTerenNou: AutoBase() {
    ...
    private val interConeTakePose = Pose2d(35.0,0.0,Math.toRadians(-97.0))//trb mai la stanga daca ma uit dinspre conuri    //era -93.0 grade //private val interConeTakePose = Pose2d(35.0,0.0,Math.toRadians(-92.0))
