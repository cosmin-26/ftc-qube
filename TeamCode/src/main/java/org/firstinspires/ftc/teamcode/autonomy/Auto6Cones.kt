...
class Auto6Cones: AutoBase() {
    ...
    private val interConeTakePose = Pose2d(35.0,0.0,Math.toRadians(-92.0)) // Mathul era -95//trb mai la stanga daca ma uit dinspre conuri    //era -93.0 grade //private val interConeTakePose = Pose2d(35.0,0.0,Math.toRadians(-92.0))
    private val vecR = Vector2d(48.0,-10.0) //-12
    private val vecConeTakePose = Vector2d(48.0,-9.5) //private val vecConeTakePose = Vector2d(48.0,-10.0)
